...
const OG = `${BASE}/api/og?title=${encodeURIComponent("Hearth Graduation")}&subtitle=${encodeURIComponent("Spark → Tokenized - when and how")}`;

export const metadata: Metadata = {
  title: "Hearth Graduation - Sparkz",
  description:
    "When a Sparkz Hearth graduates from Spark to Tokenized: the triggers, the steps, what changes, what doesn't. Token is optional. Culture comes first.",
  openGraph: {
    title: "Hearth Graduation - Sparkz",
    description:
    ...
    url: `${BASE}/graduation`,
    images: [{ url: OG, width: 1200, height: 630, alt: "Hearth Graduation - Sparkz" }],
    type: "website",
  },
  twitter: {
...
const TRIGGERS = [
  ...
  },
  {
    ...
    desc: "If the Hearth was self-serve: ZAO vetting is complete or waived for vetted creators. ZAO-vetted Hearths can graduate without a new review.",
    signal: true,
  },
];
...
const STEPS = [
  {
    ...
    body: "ZAO confirms the Hearth meets the graduation checklist: real community, locked split, no red flags. ZAO-vetted Hearths get expedited review.",
    icon: "⬡",
  },
  {
    n: "2",
...
const WHAT_CHANGES = [
  ...
  "Hearth status changes from Spark → Tokenized",
];

const WHAT_DOESNT_CHANGE = [
  "The Hearth identity, name, and bio",
  ...
  "ZAO's aligned stake - it graduates with the Hearth",
];
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-16 space-y-14">
      ...
      <section>
        ...
        <h1 className="text-4xl font-bold mb-4">Hearth Graduation</h1>
