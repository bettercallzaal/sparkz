...
const STAGES = [
  {
    ...
    notYet: ['No token', 'No split contract', 'No live fee allocation'],
  ...
  },
  {
    ...
    notYet: ['No token', 'No on-chain split', 'No live fee allocation (projected only)'],
  ...
  },
  {
    ...
    notYet: ['Full circle directory and coordinator — coming'],
    cta: { label: 'How circles work', href: '/circles' },
