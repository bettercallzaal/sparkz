...
const TOKEN_ADVICE: Record<TokenTiming, string> = {
  ...
  never:
    'No token needed. Use the patronage tier system ($5/$25/$100 backing tiers) with Stripe instead. v1 checkout is one-time; recurring billing is v2. Revenue goes directly to your 0xSplits recipients without any token mechanics.',
}
